    ...
    <button onClick={onClick}
            ...
            className={`px-6 py-2 rounded-lg font-medium transition-all duration-300
              ${size === 'small' ? "text-sm px-3 py-1":""}
               ...
               ${color==='primary' ? "bg-blue-500 hover:bg-blue-800 text-white":""}
                ${color==='secondary' ? "bg-gray-500 hover:bg-gray-800 text-white":""}
                 ${color==='danger' ? "bg-red-500 hover:bg-red-800 text-white":""}
                  ${color==='success' ? "bg-green-500 hover:bg-green-800 text-white":""}
